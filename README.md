# A great Android .apk, elf, .so and Host elf, .exe, .a compile system just with NDK and SDK fork from [git://git.videolan.org/vlc-ports/android.git](http://git.videolan.org/?p=vlc-ports/android.git),
